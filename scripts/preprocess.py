"""Data preprocessing script: extract frames, compute medians, create val split."""
...
from src.utils.general import list_dirs, generate_data_frames, get_num_frames, get_match_median
from src.utils.visualize import plot_median_files


# Replace csv to corrected csv in test set
if os.path.exists('configs/corrected_test_label'):
    ...
    for match_dir in match_dirs:
        ...
        if not os.path.exists(os.path.join(data_dir, 'test', match_dir, 'corrected_csv')):
            shutil.copytree(os.path.join('configs/corrected_test_label', match_dir, 'corrected_csv'),
                            os.path.join(data_dir, 'test', match_dir, 'corrected_csv'))
            shutil.copy(os.path.join('configs/corrected_test_label', 'drop_frame.json'),
