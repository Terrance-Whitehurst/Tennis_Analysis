...
class Shuttlecock_Trajectory_Dataset(Dataset):
    ...
    def __init__(
        ...
        seq_len: int = 8,
        sliding_step: int = 1,
        data_mode: str = "heatmap",
        bg_mode: str = "",
        frame_alpha: float = -1,
        rally_dir: str | None = None,
        frame_arr: npt.NDArray | None = None,
    ...
    def _get_rally_dict(self) -> dict[str, dict]:
    ...
    def _get_rally_i(self, rally_dir: str) -> int | None:
    ...
    def _get_split(self, rally_dir: str) -> str:
    ...
    def _gen_rally_img_congif_file(self, file_name: str) -> None:
        """Generate rally image configuration file."""
    ...
    def _gen_input_file(self, file_name: str) -> None:
    ...
    def _gen_input_from_rally_dir(self, rally_dir: str) -> dict[str, npt.NDArray]:
    ...
    def _get_heatmap(self, cx: int, cy: int) -> npt.NDArray:
...
class Video_IterableDataset(IterableDataset):
    ...
    def __gen_median__(
        self, max_sample_num: int, video_range: tuple[int, int] | None
    ) -> npt.NDArray:
    ...
    def __process__(self, imgs: npt.NDArray) -> npt.NDArray:
        """Process the frame sequence."""
        if self.bg_mode:
            median_img = self.median
        frames = np.array([]).reshape(0, self.HEIGHT, self.WIDTH)
